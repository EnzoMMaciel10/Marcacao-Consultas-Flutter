...
class _AdminScreenState
  ...
  Future<void> _carregarDados() async {
    final especialidades =
        await Storage.obterEspecialidades();

    final medicos =
        await Storage.obterMedicos();
  ...
  Future<void>
    ...
    await Storage.salvarEspecialidades(
      lista,
    );
  ...
  Future<void> _adicionarMedico() async {
    ...
    if (_especialidades.isEmpty) {
      _mostrarErro(
        'Adicione uma especialidade primeiro!',
      );
  ...
  Future<void>
      _criarConsultaTeste() async {
    final nomePaciente =
        _nomePac.text.trim();

    final dataTexto =
        _dataConsulta.text.trim();

    if (nomePaciente.isEmpty ||
        dataTexto.isEmpty) {
      _mostrarErro(
        'Preencha nome do paciente e data',
      );
    ...
    final atuais =
        await Storage.obterConsultas();

    await Storage.salvarConsultas(
      [
        ...atuais,
        novaConsulta,
      ],
    ...
    await showDialog<void>(
      ...
      builder: (
        ...
        return AlertDialog(
          ...
          content: const Text(
            'Consulta criada! Volte para Home',
          ),
          actions: [
            TextButton(
              onPressed: () {
